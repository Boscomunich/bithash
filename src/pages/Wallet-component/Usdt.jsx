...
class Usdt extends PureComponent {
...
componentDidMount() {
    fetch(`https://api.coingecko.com/api/v3/coins/tether/market_chart?vs_currency=usd&days=100&precision=6`)
    ...
    if (email) {
        fetch('https://bithash-server.onrender.com/usdt',{
        method: 'post',
