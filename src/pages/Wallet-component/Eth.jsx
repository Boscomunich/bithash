...
class Eth extends PureComponent {
...
componentDidMount() {
    fetch(`https://api.coingecko.com/api/v3/coins/ethereum/market_chart?vs_currency=usd&days=365&precision=6`)
    ...
    if (email) {
        fetch('https://bithash-server.onrender.com/eth',{
        method: 'post',
